This tool written in Maya PyMel and the OpenMaya v2 API and is tested and working as of Maya 2027. It is meant for optimizing meshes in some commonly useful ways.  
